<template>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container-fluid">
      ...
      <div id="navbarResponsive" class="collapse navbar-collapse order-last">
        <form
          class="form-inline col-lg-7 col-12 ml-auto justify-content-center my-2"
        >
          <div class="search-input w-100">
            ...
            <button
              ...
              @click="clearSearch"
            >
              <img src="../../assets/images/forward.svg" alt="Close" />
            </button>
          </div>
        </form>
        <ul class="navbar-nav ml-auto">
          <li class="nav-item" :class="{ active: currentPage === 'home' }">
            <nuxt-link class="nav-link" to="/">
              Home
              <span v-if="currentPage === 'home'" class="sr-only"
                >(current)</span
              >
            </nuxt-link>
          </li>
          <li class="nav-item" :class="{ active: currentPage === 'about' }">
            <nuxt-link class="nav-link" to="/about">
              About
              <span v-if="currentPage === 'about'" class="sr-only"
                >(current)</span
              >
            </nuxt-link>
          </li>
  ...
  methods: {
    handleInputChange(e) {
      ...
      this.typeTimer = setTimeout(() => {
        ...
        if (this.$route && !['index', 'index'].includes(this.$route.name)) {
